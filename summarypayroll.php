  ...
  <?php
                                                ...
                                                while($row = mysqli_fetch_array($query)) {  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right;">'.number_format($basicpay+$overtimepay-($ssscont+$philhealthcont+$pagibigcont+$taxcont+$cashadvance+$cashloan+$cashloansss+$lesslate), 2, '.', ',').'</td>
                                                    </tr>
                                                    ';
                                                }
        ...
        <table class="table table-bordered">
            <tbody>
                <tr>
                    ...
                    <td style="width: 80px; text-align: right;"><?php echo number_format($cashloansssgrandtotal, 2, '.', ','); ?></td>
